...
public class ReConfigs {
    ...
    public static final ModConfigSpec.BooleanValue PANORAMIC_SCREENSHOTS = BUILDER.comment("Whether panoramic screenshots can be taken using Ctrl + [Screenshot Key].").translation("config.reutilities.panoramic_screenshots").define("miscellaneous.panoramicScreenshots", false);
    public static final ModConfigSpec.IntValue PANORAMIC_SCREENSHOT_SIZE = BUILDER.comment("How big the each screenshot should be. Defaults to 1024px.").translation("config.reutilities.panoramic_screenshot_size").defineInRange("miscellaneous.panoramicScreenshotSize", 1024, 32, 8192);
