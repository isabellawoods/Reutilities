...
public class ReConfigs {
    ...
    public static final ModConfigSpec.IntValue PANORAMIC_SCREENSHOT_SIZE = BUILDER.comment("How big the each screenshot should be. Defaults to 1024px.", "Increasing the resolution will lead to images with better quality, but at the cost of performance and storage space.").translation("config.reutilities.panoramic_screenshot_size").defineInRange("miscellaneous.panoramicScreenshotSize", 1024, 32, 8192);
